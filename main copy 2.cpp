...
void cameraController()
{
    ...
    drawstring(-1, -0.65, -2.7, "Stuart: How about a volleyball match, Stuart? Let's see who is the better player! The loser will be in charge of cooking dinner tonight.");
    if (count < 10)
    {
        xpos = -2;
        ypos = 2;
...
void bobController()
{
    ...
    // {
    //     drawstring(-1, -0.7, -2.7, "Bob: What a perfect day at the beach, Stuart!");
    // }
